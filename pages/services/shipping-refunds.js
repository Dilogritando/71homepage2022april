...
const Shipping = () => {
  return (
    <div className={styles.ProductPages__container}>
      ...
      {/*       <ProductPageFactsBox
        factsColor="#0496FF"
        factsHeader="Did you know that if your FedEx/UPS shipment is delivered late -even by <span>60 seconds<span> -  your company is entitled to a full refund?"
      ...
      />
      <ProductPageTestimonial featuredTestimonial="I encourage all of our members to get in touch with 71lbs because <span> they will make the process effortless </span> for tracking shipments and collecting refunds when deliverables are not on time." />
      <ProductPageImageQuote
        lastTitle="$2 billion dollars "
        lastLead="are left unclaimed every year
        customer quote/testimonial"
        lastImgSource="/assets/productPagesAssets/Shipping-CTA2.png"
